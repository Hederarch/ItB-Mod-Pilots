...
return {
	...
	-- Shared Missions
	Mission_Train_TrainStopped = {"Don't get mad at them, the engineers can still fix that."},
	Mission_Train_TrainDestroyed = {"They played too roughly with the train it seems."},
	Mission_Block_Reminder = {"Let's just keep them underground and forget all this fighting."},

	-- Archive
	Mission_Airstrike_Incoming = {"Are these bombers really necessary?"},
	Mission_Tanks_Activated = {"Aha! The tanks are ready to play!"},
	Mission_Tanks_PartialActivated = {"Aha! The tank is ready to play!"},
	Mission_Dam_Reminder = {"I don't want to either, but the dam has to go."},
	Mission_Dam_Destroyed = {"There goes a piece of paradise."},
	Mission_Satellite_Destroyed = {"Dewey's going to be heartbroken."},
	Mission_Satellite_Imminent = {"The engines are getting louder. It's about to blow!"},
	Mission_Satellite_Launch = {"Up like a firework. Let's hope it doesn't explode now."},
	Mission_Mines_Vek = {"Now that's just cruel."},

	-- RST
	Mission_Terraform_Destroyed = {"They were just defending themselves. That thing's terrifying."},
	Mission_Terraform_Attacks = {"Turn that thing down! You'll make me deaf!"},
	Mission_Cataclysm_Falling = {"There goes a piece of paradise."},
	Mission_Lightning_Strike_Vek = {"Let's hope it went down painlessly."},
	Mission_Solar_Destroyed = {"The Vek play so rough around these fragile panels."},
	Mission_Force_Reminder = {"The mountains are pretty, but they've got to go."},

	-- Pinnacle
	Mission_Freeze_Mines_Vek = {"At last, a humane solution."},
	Mission_Factory_Destroyed = {"It was just putting everyone in danger."},
	Mission_Factory_Spawning = {"Remind me why we're saving this thing again?"},
	Mission_Reactivation_Thawed = {"They're awake, and very grumpy."},
	Mission_SnowStorm_FrozenVek = {"Poor thing would shiver if it wasn't immobile."},
	Mission_SnowStorm_FrozenMech = {"I don't think this will thaw on its own."},
	BotKilled_Self = {"That can't feel pain, can it?"},
	BotKilled_Obs = {"Do these bots feel pain?"},

	-- Detritus
	Mission_Disposal_Destroyed = {"They were just defending themselves. That thing's terrifying."},
	Mission_Disposal_Activated = {"What a horrific contraption."},
	Mission_Barrels_Destroyed = {"Look out below, dear!"},
	Mission_Power_Destroyed = {"Were we supposed to protect those?"},
	Mission_Teleporter_Mech = {"The teleport's scrambled my radio. You can still hear me, right?"},
	Mission_Belt_Mech = {"Whee! What a ride!"},
}